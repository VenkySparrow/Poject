...
if(isset($Submit))
{
$waiter_name=$_REQUEST['waiter_name'];
...
$password=$_REQUEST['password'];
 ...
 $sql = "SELECT id FROM waiter_details order by id ASC";
...
$cdate=date('d-m-Y H:i');
   $qrys1="insert into waiter_details values($sid,'$waiter_name','$contact','$email','$address','$aadhar_no','$password','0','0')";
  if ($conn->query($qrys1) === TRUE) {
  ?>
<script language="javascript" type="text/javascript">
alert("Upload Success");
window.location.href="admin_add_waiter.php";
</script>
<?php   
 }
 else
...
<body>
    ...
    <div class="inner-banner">
        <section class="w3l-breadcrumb">
            <div class="container">
                <h4 class="inner-text-title font-weight-bold text-white mb-sm-3 mb-2">Admin</h4>
            ...
            <div class="container py-lg-5">
              <div class="middle-section text-center">
                    <div class="section-width">
                        <h3 class="title-style">Add Waiter </h3>
                     
                    </div>
                 

                    <form action="" method="post" enctype="multipart/form-data" name="form1">
                      <table width="431" height="232" align="center">
                        <tr>
                          <td width="149"><div align="left">Waiter  Name </div></td>
                          <td width="270"> 
                            <div align="left">
                              <input name="waiter_name" type="text" id="waiter_name" required="">
                             </div></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          <td height="26"><div align="left">Email</div></td>
                          <td><div align="left">
                        ...
                        <tr>
                          <td><div align="left">Aadhar No </div></td>
                          <td><div align="left">
                            <input name="aadhar_no" type="text" id="aadhar_no" required="">
                          </div></td>
                        </tr>
                        <tr>
