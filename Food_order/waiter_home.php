...
<body>
 ...
 $qrys1="select * from  booking_details where status='1' and report='0'";
	 ...
	 ?>
                        <tr>
                         <td>  <h6><?php echo $row['table_no'];?> </h6> </td>
                         <td>  <h6><?php echo $row['food_name'];?> </h6> </td>
                          <td><h6><?php echo $row['quantity'];?> </h6></td>
                          <td>  <a href="waiter_home_served.php?id=<?php echo $row['id'];?>">Served</a> </td>
                        </tr>
						  <?php
	 }
	 ?>
