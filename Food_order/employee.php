...
$password=$_REQUEST['password'];
 $_SESSION['waiter']=$name;
 $qry="select * from waiter_details where waiter_name='$name' && password='$password'";
            ...
            <div class="container py-lg-5">
              <div class="middle-section text-center">
                    <div class="section-width">
                        <h3 class="title-style">Employee Login</h3>
                    ...
                    <form name="form1" method="post" action="">
                      <table height="127" align="center">
                        <tr>
                          <td>Username</td>
                          <td><input type="text" name="username" placeholder="Waiter Name" required=""></td>
                        </tr>
                        <tr>
                          <td>Password</td>
