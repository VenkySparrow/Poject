    ...
    <section class="w3l-index5" id="about">
            ...
            <div class="container py-lg-5">
              <div class="middle-section text-center">
                    <div class="section-width">
                        <h3 class="title-style">Food Details </h3>
                    ...
                    <form name="form1" method="post" action="">
                      <p>&nbsp;</p>
                      <table width="90%" height="127" border="1" align="center">
                        <tr>
                          <td>Id</td>
                          <td>Food Name</td>
                          <td>Type</td>
	 ...
	 ?>
                        <tr>
                          ...
                          <td><img src="upload/<?php echo $row['fname'];?>" width="100" height="100"><?php echo $row['fname'];?></td>
                        </tr>
                        <?php
	 }
	 ?>
