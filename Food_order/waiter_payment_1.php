...
session_start();
 ...
 $table_no=$_SESSION['table_no'];
   $qrys1="select * from  booking_details where table_no='$table_no' and status='1'";
  ...
  if(isset($Submit))
{
	$up_fees="update booking_details set  status='2' where  table_no='$table_no'"; 
if($conn->query($up_fees) === TRUE)
{
?>
		 <script language="javascript">
           alert("Payment Received Success");
             window.location.href="waiter_payment.php";
            </script>
			<?php
} 
            ...
            <div class="container py-lg-5">
              <div class="middle-section text-center">
                    ...
                    <form name="form1" method="post" action="">
                      <table width="100%" height="122" align="center">
                        <tr>
                          <td><div align="center">
                            <h2>Table No : <?php echo $table_no;?></h2>
                          </div></td>
                        </tr>
                        <tr>
                          <td><div align="center">
                            <h2>Amount : <?php echo $t;?></h2>
                          </div></td>
                        </tr>
                        <tr>
                          <td height="26"><div align="center">
                              <input type="submit" name="Submit" value="Amount Received">
                          </div></td>
                        </tr>
                        <tr>
                          <td>&nbsp;</td>
