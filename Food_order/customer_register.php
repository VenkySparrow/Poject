...
$password=$_REQUEST['password'];
 ...
 $sql = "SELECT id FROM customer_details order by id ASC";
 ...
 $sid=0;
  ...
  while($row = $result->fetch_assoc()) 
  {
   ...
   $qrys1="insert into customer_details values($sid,'$name','$contact','$email','$address','$password','0','0')";
            ...
            <div class="container py-lg-5">
              <div class="middle-section text-center">
                    <div class="section-width">
                        <h3 class="title-style">Customer Register </h3>
                    ...
                    <form name="form1" method="post" action="">
                      <table height="127" align="center">
                        <tr>
                          <td>Name</td>
                          <td><input name="name" type="text" id="name" placeholder="Name" required=""></td>
                        </tr>
                        <tr>
                          <td>Contact</td>
                          <td><input name="contact" type="text" id="contact" placeholder="Contact" required=""></td>
                        </tr>
                        <tr>
                          <td>Email</td>
                          <td><input name="email" type="text" id="email" placeholder="Email" required=""></td>
                        </tr>
                        <tr>
                          <td>Address</td>
