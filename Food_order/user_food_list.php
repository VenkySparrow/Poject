...
session_start();
 ...
 if(isset($Submit))
{
$up_fees="update booking_details set  status='1' where user='$user' and status='0'"; 
if($conn->query($up_fees) === TRUE)
{
?>
		 <script language="javascript">
           alert("List Confirmed");
             window.location.href="user_food_payment.php";
            </script>
			<?php
}
}
...
<body>
 ...
 $qrys1="select * from  booking_details where user='$user' and status='0'";
