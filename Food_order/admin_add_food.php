...
move_uploaded_file($_FILES["file"]["tmp_name"],"upload/".$fname1);
 $sql = "SELECT id FROM food_details order by id ASC";
...
$cdate=date('d-m-Y H:i');
   $qrys1="insert into food_details values($sid,'$food_name','$type','$price','$fname1','0','0')";
  if ($conn->query($qrys1) === TRUE) {
  ?>
<script language="javascript" type="text/javascript">
alert("Upload Success");
window.location.href="admin_add_food.php";
</script>
<?php   
 }
 else
            ...
            <div class="container py-lg-5">
              <div class="middle-section text-center">
                    <div class="section-width">
                        <h3 class="title-style">Add Food </h3>
                    ...
                    <form action="" method="post" enctype="multipart/form-data" name="form1">
                      <table width="431" height="232" align="center">
                        <tr>
                          <td width="149"><div align="left">Food Name </div></td>
                          <td width="270"> 
                            <div align="left">
                              <input name="food_name" type="text" id="food_name" required="">
                             </div></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          <td height="26"><div align="left">Price</div></td>
                          <td><div align="left">
                        ...
                        <tr>
                          ...
                          <td><div align="left">
                            <input name="desc" type="text" id="desc" required="">
                          </div></td>
                        </tr>
                        <tr>
